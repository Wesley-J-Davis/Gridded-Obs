#!/usr/bin/csh
set echo
setenv BinDir /discover/nobackup/dao_ops/TEST/M2_GRITAS/github_repo/M2_GRITAS/GrITAS/Linux/bin
...
set IN_DIR      = /discover/nobackup/projects/p53/merra2/data/obs/.WORK/products
set OUT_DIR     = /discover/nobackup/projects/p53/merra2/data/obs/.WORK/products_revised
	...
	foreach HOUR ( `echo $SYNOP_TABLE` )
		...
		# TIME STAMPS FOR GLOBAL METADATA
			...
			set dd		= `echo ${CurrentMonth_LastDay} | cut -c7-8`
        	        ...
        	        set granule 	= "$OUT_DIR/${INSTRUMENT}/d/Y${YEAR}/M${MONTH}/merra2.${INSTRUMENT}.${YEAR}${MONTH}${SYNOP}.nc4"
	                set granuleid 	= merra2.${INSTRUMENT}.${YEAR}${MONTH}${SYNOP}.nc4
	                echo $granule
	        endif
		
		cp $TARGET_DIR/$granuleid $granule
