...
ls -1 $OBS_DIR/Y${YYYY}/M${MM}/D*/H${SYNOP}/*${INSTRUMENT_TABLE}*${SYNOP}z*ods
set ods_Files = `ls -1 $OBS_DIR/Y$YYYY/M$MM/D*/H${SYNOP}/*${INSTRUMENT_TABLE}*`
...
foreach FILE ( $ods_Files )
  ...
  #dmget $FILE 
  #wait
  rsync -av $FILE $WORK_DIR/$INSTRUMENT_TABLE/$Date
end
